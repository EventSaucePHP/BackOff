...
class ExponentialBackOffStrategyTest extends TestCase
{
    ...
    {
        $backoff = new ExponentialBackOffStrategy(100, 25, 250000, 2.0, $this->sleeper);
    ...
    {
        $backoff = new ExponentialBackOffStrategy(100, 25, 600, 2.0, $this->sleeper);
        $backoff->backOff($tries, new RuntimeException('oops'));
    ...
    {
        $backoff = new ExponentialBackOffStrategy(100, $maxTries, 2500000, 2.0, $this->sleeper);
    ...
    {
        $backoff = new ExponentialBackOffStrategy(100, 100, 100, 2.0, $this->sleeper);
        $exception = new RuntimeException('oops');
    ...
    {
        $backoff = new ExponentialBackOffStrategy(100, 100, 1000, $exponent, $this->sleeper);
        $backoff->backOff($tries, new RuntimeException('oops'));
